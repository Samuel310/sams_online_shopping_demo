...
import 'package:obs_admin/screens/analytics/screen.analytics.dart';
import 'package:obs_admin/screens/common/screen.appbar.dart';
import 'package:obs_admin/util/constants.dart';

class AnalyticsSliderScreen extends StatefulWidget {
  @override
  _AnalyticsSliderScreenState createState() => _AnalyticsSliderScreenState();
}

class _AnalyticsSliderScreenState extends State<AnalyticsSliderScreen> {
  int currentIndex = 0;
        ...
        child: Container(
          ...
          child: Stack(
            children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: PageView(
                          ...
                          children: <Widget>[
                            AnalyticsScreen(screenName: "wishlist"),
                            AnalyticsScreen(screenName: "cart"),
                          ],
                        ),
                      ),
                    ],
              ...
              appBar(title: "Analytics", showBackArrow: true, context: context, showSearchIcon: true),
            ],
          ),
        ),
      ),
