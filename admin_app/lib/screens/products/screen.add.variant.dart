...
class AddNewVariant extends StatefulWidget {
  final String productId;
  AddNewVariant({this.productId});
  @override
  _AddNewVariantState createState() => _AddNewVariantState();
}

class _AddNewVariantState extends State<AddNewVariant> {
  ...
  void onSaveBtnClicked() async {
    if (colorController.text.isNotEmpty &&
      ...
      String res = await ManageProductService().addNewVariant(this.widget.productId, variant, imageFileList);
